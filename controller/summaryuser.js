app.controller('summaryuser', function($scope, $http, $location, $timeout, $window) {
    $scope.init = function() {
    ...
    $scope.getsummaryuser   =   function() {
      alert('hello');
        ...
        $http({
                method: "GET",
                url: "http://103.127.157.28:8443/summaryusercountforcreatedlead?Useremail=" + adminemail + "&token=" + token + 
    ...
    $scope.getcreatedDate=function(created){
        ...
        var email           =   localStorage.getItem("userforsummary");
           $http({
        method: "GET"
        , url: "http://103.127.157.28:8443/summaryuserforcreatedlead?Useremail=" + adminemail + "&token=" + token+ "&email="+email+"&createddate="+createddate
        , transformRequest: function (obj) {
          var str = [];
          for (var p in obj)
            str.push(encodeURIComponent(p) + "=" + encodeURIComponent(obj[p]));
      ...
      .then(function (response) {
        ...
        var email           =   localStorage.getItem("userforsummary");
           $http({
        method: "GET"
        , url: "http://103.127.157.28:8443/summaryuserformodifiedlead?Useremail=" + adminemail + "&token=" + token+ "&email="+email+"&modifieddate="+modifieddate
        , transformRequest: function (obj) {
          var str = [];
          for (var p in obj)
            str.push(encodeURIComponent(p) + "=" + encodeURIComponent(obj[p]));
