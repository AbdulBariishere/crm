...
app.controller('tracknovatereports', function ($scope, $http, $location, $timeout, $window) {
      ...
      .then(function (response) {
        ...
        if (response.data.status == true) {
         ...
         // console.log(response.data.data);
          ...
          $location.path("/tracknovatereports");
  ...
  $scope.shwobuttons=function(){

    if ($scope.showbutton = !$scope.showbutton) {
      var x = document.querySelectorAll("#visiblebutton");
